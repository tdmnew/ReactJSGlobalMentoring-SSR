...
describe('Testing Sagas', () => {
  ...
  it('Gets a movie', () => expectSaga(getMovieSaga, api.getMovie)
  ...
  it('Searches movies', () => expectSaga(searchMoviesSaga, api.searchMovies)
  ...
  it('Deletes a movie', () => expectSaga(deleteMovieSaga, 1).dispatch(deleteMovie(1)).run());
});
